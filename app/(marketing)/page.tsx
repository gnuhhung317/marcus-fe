...
export default async function HomePage() {
  ...
  return (
    <div className="shell-grid relative w-full overflow-hidden pb-32">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[rgba(0,190,115,0.06)] blur-[100px]"></div>

      {/* Hero Section */}
      <section className="relative z-10 mx-auto max-w-7xl px-4 pt-20 sm:px-6 lg:px-8 lg:pt-32">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr]">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-[rgba(0,190,115,0.2)] bg-[rgba(0,190,115,0.05)] px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-positive">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              <Link
                href="/research"
                className="rounded-xl border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.03)] px-8 py-3.5 text-sm font-bold uppercase tracking-wide text-white backdrop-blur transition-colors hover:bg-[rgba(255,255,255,0.08)]"
              >
                Read Documentation
              </Link>
            </div>
          ...
          <div className="glass noise relative overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[#0b0e14]/80 shadow-2xl">
            <div className="flex items-center gap-2 border-b border-[rgba(255,255,255,0.05)] bg-[#151921] px-4 py-3">
              <div className="h-3 w-3 rounded-full bg-[#f43f5e]"></div>
              <div className="h-3 w-3 rounded-full bg-[#facc15]"></div>
              <div className="h-3 w-3 rounded-full bg-[#00be73]"></div>
      ...
      {marketingStats && (
        <section className="relative z-10 mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="glass noise grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.08)] sm:grid-cols-4">
            <div className="bg-[#0b0e14]/60 p-6 text-center sm:p-8">
      ...
      <section className="relative z-10 mx-auto mt-32 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          ...
          <div className="glass noise relative rounded-2xl p-8 transition-transform hover:-translate-y-1">
            <div className="absolute -left-3 -top-3 flex h-10 w-10 items-center justify-center rounded-xl bg-positive font-display text-lg font-bold text-[#022c22]">
              1
            </div>
            <div className="mb-6 inline-block rounded-lg bg-[rgba(255,255,255,0.05)] p-3">
      ...
      <section className="relative z-10 mx-auto mt-32 max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <div className="glass rounded-3xl p-10 sm:p-16">
          ...
          <div className="mt-8 flex justify-center gap-4">
            <a href="#" className="inline-flex items-center gap-2 rounded-xl bg-[#5865F2] px-6 py-3 text-sm font-bold text-white transition-opacity hover:opacity-90">
            ...
            <a href="#" className="inline-flex items-center gap-2 rounded-xl border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-[rgba(255,255,255,0.1)]">
              Developer Forums
            </a>
          </div>
        </div>
