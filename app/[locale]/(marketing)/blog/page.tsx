import { ArrowRight, FileText, PenLine, RadioTower } from 'lucide-react';
...
export default async function BlogPage() {
  ...
  const roadmap = [
    {
      icon: PenLine,
      title: t('roadmap.editorial.title'),
      description: t('roadmap.editorial.description'),
    },
    {
      icon: FileText,
      title: t('roadmap.research.title'),
      description: t('roadmap.research.description'),
    },
    {
      icon: RadioTower,
      title: t('roadmap.publishing.title'),
      description: t('roadmap.publishing.description'),
    },
  ];
          ...
          <Card variant="glass-strong" className="p-6">
            ...
            <div className="mt-6 space-y-3">
              <div className="rounded-2xl border border-border/70 bg-surface/70 p-4">
                <p className="text-[11px] uppercase tracking-[0.16em] text-muted">{t('status.postsLabel')}</p>
                <p className="mt-2 text-sm font-semibold text-main">{t('status.postsValue')}</p>
              </div>
              <div className="rounded-2xl border border-border/70 bg-surface/70 p-4">
                <p className="text-[11px] uppercase tracking-[0.16em] text-muted">{t('status.reviewLabel')}</p>
                <p className="mt-2 text-sm font-semibold text-main">{t('status.reviewValue')}</p>
              </div>
              <div className="rounded-2xl border border-border/70 bg-surface/70 p-4">
