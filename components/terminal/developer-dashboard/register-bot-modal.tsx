        ...
        <div className="relative mt-6 flex-1 overflow-y-auto pr-1">
          {!credentials ? (
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 font-sans">
              <div>
                <label className="mb-2 block text-xs font-bold uppercase tracking-wider text-muted">Bot Name</label>
                <input
                  type="text"
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="mb-2 block text-xs font-bold uppercase tracking-wider text-muted">Exchange Venue</label>
                  <select
                ...
                <div>
                  <label className="mb-2 block text-xs font-bold uppercase tracking-wider text-muted">Trading Pair</label>
                  <input
                    type="text"
            ...
            <div className="space-y-6">
              ...
              <div className="relative group">
                <div className="mb-1 flex items-center justify-between font-sans">
                  <span className="text-[9px] font-bold uppercase tracking-wider text-muted">Bot ID</span>
                  <button
              ...
              <div className="relative group">
                <div className="mb-1 flex items-center justify-between font-sans">
                  <span className="text-[9px] font-bold uppercase tracking-wider text-muted">Public API Key</span>
                  <button
              ...
              <div className="relative group">
                <div className="mb-1 flex items-center justify-between font-sans">
                  <span className="text-[9px] font-bold uppercase tracking-wider text-positive">Signing Secret (rawSecret)</span>
                  <button
