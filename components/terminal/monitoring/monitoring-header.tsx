    ...
    <header className="flex flex-col gap-5 border-b border-border pb-6 lg:flex-row lg:items-end lg:justify-between">
      <div className="space-y-3">
        <div className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-[0.2em] text-muted">
          <Badge variant="success" className="px-2.5 bg-positive/8">
            Phase 2
          </Badge>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <Badge 
          ...
          className={cn(
            "px-3 py-2 text-sm",
            isUp ? "bg-positive/10" : "bg-warning/10"
          )}
        >
          {connectivityStatus}
        </Badge>
        <Button
          ...
          className="border-positive/30 bg-positive/8 text-positive hover:bg-positive/12"
        >
          Refresh
        </Button>
      </div>
